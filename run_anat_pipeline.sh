...
MASK_APPLY_SCRIPT="${MASK_APPLY_SCRIPT:-$SCRIPT_DIR/src/apply_mask.py}"
RARE_ALIGN_SCRIPT="${RARE_ALIGN_SCRIPT:-$SCRIPT_DIR/src/register_rare_to_atlas.sh}"
ALIGN_SCRIPT="${ALIGN_SCRIPT:-$SCRIPT_DIR/src/apply_transforms_to_maps.sh}"
RARE_TEMPLATE_SCRIPT="${RARE_TEMPLATE_SCRIPT:-$SCRIPT_DIR/src/build_study_template.sh}"
APPLY_TO_TEMPLATE_SCRIPT="${APPLY_TO_TEMPLATE_SCRIPT:-$SCRIPT_DIR/src/project_maps_to_template.sh}"
MAKE_TEMPLATE_SCRIPT="${MAKE_TEMPLATE_SCRIPT:-$SCRIPT_DIR/src/average_maps.sh}"
ROI_SCRIPT="${ROI_SCRIPT:-$SCRIPT_DIR/src/extract_roi_stats.py}"
